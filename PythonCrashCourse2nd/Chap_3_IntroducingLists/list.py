...
# If only delete item from a List and not use item deleted
# then use def function else use pop function
...
cars = ['bmw', 'Audi', 'Toyota', 'Subaru']
cars.sort()
print(cars)  # result = ['Audi', 'Subaru', 'Toyota', 'bmw']
...
print('4.3 Printing a list in reverse order')
cars = ['bmw', 'audi', 'toyota', 'subaru']
cars.reverse()
print(cars)

# 4.4 Finding the length of a List
print('4.4 Finding the length of a List')
length = len(cars)
print(length)  # result = 4 => start with One
